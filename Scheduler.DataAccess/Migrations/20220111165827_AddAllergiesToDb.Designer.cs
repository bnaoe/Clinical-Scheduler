...
namespace ClinicalScheduler.Migrations
{
    ...
    [Migration("20220111165827_AddAllergiesToDb")]
    partial class AddAllergiesToDb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Scheduler.Models.Allergy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Scheduler.Models.Patient", b =>
                {
                    b.HasOne("Scheduler.Models.CodeValue", "Ethnicity")
                        .WithMany()
                        .HasForeignKey("EthnicityId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Scheduler.Models.CodeValue", "Gender")
                        .WithMany()
                        .HasForeignKey("GenderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Scheduler.Models.CodeValue", "Race")
                        .WithMany()
