            ...
            },
            {
                ...
                "render": function (data) {
                    return `
                        ...
                        <a href="/Admin/CodeSet/Upsert?id=${data}" class="btn btn-primary small mx-2 disabled">
                        <i class="bi bi-pencil-square"></i> Edit</a>
                        <a onClick=Delete('/Admin/CodeSet/Delete?id=${data}') class="btn btn-danger small mx-2 disabled">
